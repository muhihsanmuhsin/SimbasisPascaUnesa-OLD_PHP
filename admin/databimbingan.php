...
<div class="container">
  <div class="py-5 text-center">
    <h2>Daftarkan Bimbingan</h2>
  </div>

    <div class="col-md-12 order-md-1">

        <div class="mb-3">
            <label for="no">NIM | MAHASISWA</label>
            <input type="text" class="form-control" id="nim" placeholder="..." required=""> 
        ...
        <div class="mb-3">
            <label for="no">NIP | Dosen Pembimbing 1</label>
            <input type="text" class="form-control" id="dos1" placeholder="..." required=""> 
            <div class="invalid-feedback">
              Masukkan !.
            </div>
        </div>
        ...
        <div class="mb-3">
            <label for="no">NIP | Dosen Pembimbing 2</label>
            <input type="text" class="form-control" id="dos2" placeholder="..." required=""> 
            <div class="invalid-feedback">
              Masukkan !.
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="jdul" placeholder="Judul Tesis.." required="">
            <div class="invalid-feedback">
              Masukkan Judul!.
            </div>
        </div>

        <button class="btn btn-primary btn-lg btn-block" type="submit">Buat Bimbingan Baru</button>
      </form>
    </div>
  </div>
